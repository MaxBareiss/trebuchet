...
function rangeObjective(params)
    ...
    [cost,rL,fallingsol,swingingsol,swingingBallsol,flightsol]
end

#        m1    h0  L1  L2  L3   β2   β3   β4
x0 =    [ 30.0,0.8,0.4,0.8,0.35,0.9, 0.0,-0.3]
lower = [  5.0,0.2,0.2,0.2,0.2 ,0.0,-0.5,-0.5]
upper = [150.0,3.0,3.0,3.0,3.0 ,1.5, 0.5, 0.5]
...
rangeThrown,rL,fallingsol,swingingsol,swingingBallsol,flightsol = rangeObjective(params)
